    ...
    <section className="relative login-bg flex min-h-screen overflow-hidden ">
          <div className="container absolute left-60 max-lg:left-0 max-lg:px-4 px-30 my-10">
            ...
            <div className="flex flex-col mt-15 mb-4">
                ...
                <label htmlFor="email" className="uppercase text-[#030742] font-bold text-md">Email</label>
                  <p className="text-sm text-red-500 ">{errors.email?.message}</p>
                <input type="email" placeholder="Your Name" {...register("email")} className="p-2 mt-2 border-b-2 border-[#030742] text-[#030742] focus:outline-none"/>
